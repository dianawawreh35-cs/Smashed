...
**The PBX is a Yeastar S20, and AMI is TCP 5038** (S-50). AMI availability is an
explicit client dependency (§12.3): if the S20 does not expose it, S-55 (CDR
...
- SRS §10 lists three [TBC] items the client must answer before installation:
  whether the S20 exposes AMI and whether inbound routing is a queue or a ring
