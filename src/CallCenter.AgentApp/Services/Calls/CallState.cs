...
/// </remarks>
/// <param name="Number">
/// As the PBX presented it. Null or blank when the caller withheld it — the
/// pop-up says so rather than showing an empty line.
/// </param>
    ...
    DateTimeOffset? ConnectedAt)
{
    ...
    public static readonly CallState Idle = new(CallStatus.Idle, null, null, null);
